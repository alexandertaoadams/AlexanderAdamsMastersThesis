...
def Gram_XX(X, X_batch_size, n_timesteps, n_nontrivial_levels):
...
def Cross_XZ(X, Z, X_batch_size, Z_batch_size, n_timesteps, n_nontrivial_levels):
...
def Diag_XX(X, X_batch_size, n_timesteps, n_nontrivial_levels):
